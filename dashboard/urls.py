...
from .views import get_help, get_videos, get_about,get_video_detail,get_user_notifications,get_user_notification,get_user_profile,edit_user_profile_view,daily_transaction_list,daily_transaction_create,daily_transaction_delete,daily_transaction_update
...
urlpatterns = [
    ...
    path('transactions/', daily_transaction_list, name='daily_transaction_list'),
